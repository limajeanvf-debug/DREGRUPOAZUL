...
async function bootstrapSchema() {
  try {
    ...
    await pool.query(`INSERT INTO dre.categorias (grupo, codigo, nome, aplica_tipo, ordem) VALUES
      ...
      ON CONFLICT (codigo) DO UPDATE
        SET nome=EXCLUDED.nome, aplica_tipo=EXCLUDED.aplica_tipo, grupo=EXCLUDED.grupo`);
...
app.get('/api/health', (req, res) => res.json({ ok: true, versao: 'itens-outras-despesas-2026-08-14' }));
